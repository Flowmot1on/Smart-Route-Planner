# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 15:57:38 2019
        ...
        for device in dvc.DeviceId: 
            ...
            for i in df.index:
                ...
                if(df.routeId[i] != 0 ):
                    ...
                    if (df.accurancy[i] < 0.95):
                        print(df.accurancy[i])    
                        for j in helper.index:
                        ...
                        df.at[i, 'routeId'] = liste1[max_index]
                        df.at[i,'accurancy'] = liste[max_index] 
